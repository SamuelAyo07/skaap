...
const Index = () => {
  ...
  return (
    <div className="min-h-screen font-sans overflow-x-hidden" style={{ background: "#0A0F1E" }}>
      ...
      <section className="py-3" style={{ background: "#0A0F1E" }}>
      ...
      <section className="py-3" style={{ background: "#FBF6E9" }}>
      ...
      <section className="py-3" style={{ background: "#FFFFFF" }}>
        <div className="max-w-5xl mx-auto px-4">
          <FadeIn>
      ...
      <section className="py-3" style={{ background: "#F9FAFB" }}>
